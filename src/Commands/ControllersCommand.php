...
class ControllersCommand extends Command
{
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/fareesh/voyager/src/Http/Controllers'));
    ...
    {
        return $this->filesystem->get(base_path('/vendor/fareesh/voyager/stubs/'.$this->stub));
    }
